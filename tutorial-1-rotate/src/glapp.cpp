...
void GLApp::GLModel::setup_shdrpgm() {
	...
	shdr_files.emplace_back(std::make_pair(
		GL_VERTEX_SHADER,
		"../shaders/my-tutorial-1-rotate.vert"));
	shdr_files.emplace_back(std::make_pair(
		GL_FRAGMENT_SHADER,
		"../shaders/my-tutorial-1-rotate.frag"));
...
void GLApp::GLModel::draw() {
	...
	shdr_pgm.Use();
	GLuint loc_rotmtx = glGetUniformLocation(shdr_pgm.GetHandle(), "rot_mtx");
	glUniformMatrix3fv(loc_rotmtx, 1, GL_FALSE, rot_mtx);
